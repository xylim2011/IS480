...
public class Twitter {
    ...
    public JSONObject getTwitterAccessTokenFromAuthorizationCode(String oauth_token, String verifier_or_pin) {
        JSONObject jsonresponse = new JSONObject();
        ...
        try {
            ...
            if (response.getStatusLine().toString().indexOf("500") != -1) {
                ...
                if (jo.has("errors")) {
                    ...
                    jsonresponse.put("twitter_object", jo); // this is the full result object from Twitter
                }
    ...
    public JSONObject getTweet(String id, String access_token, String access_token_secret) {
        JSONObject jsonresponse = new JSONObject();
    ...
    public static HttpResponse createHTTPConnection(String twitter_endpoint, String twitter_endpoint_host, String twitter_endpoint_path, String authorization_header_string, String verifier_or_pin, DefaultHttpClientConnection conn, BasicHttpEntityEnclosingRequest request) {
        ...
        try {
            ...
            request.addHeader("Authorization", authorization_header_string); // this is where we're adding that required "Authorization: BLAH" header.
